...
import {
  ...
  Stack,
  Avatar,
  Button, List, ListItem, ListItemAvatar, ListItemText, Rating,
} from "@mui/material";
...
const ClientProjectPage = () => {
  ...
  return (
    <Container sx={{ p: {xs: 0, sx: 1, md: 2, lg: 4} }}>
          <Grid container>
            <Grid item xs={12} md={8} lg={9}>
              ...
              >
                ...
                />
                <Button variant='text' startIcon={<EditNote />}>Edit Project</Button>
                <Button variant='text' color='error' startIcon={<DeleteIcon />}>Delete Project</Button>
              </Stack>
              ...
              <Grid container spacing={2}>
                ...
                <Grid item xs={12} md={4} lg={3}>
                  ...
                  <Typography variant='h5' fontWeight='bold'>Applicants</Typography>
                  <List sx={{padding: 2}}>
                    {[1,2,3].map((index) => {
                      ...
                      >
                        ...
                        <ListItemText
                            primary={editor.name}
                            secondary={<Button variant='text' color='success'>Accept</Button>}
                        />
                      </ListItem>)
                    })}
                  </List>
